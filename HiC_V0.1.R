...
#Our networks are by definition bipartite, i.e we can construct two distincts ensembls from its cluster elements
...
results[results$namespace_1003 == "biological_process",]
